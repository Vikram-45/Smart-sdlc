...
st.markdown("""
    <div class="feature-card">
        <p style="text-align: center; color: #b3b3b8; font-size: 1.2rem; margin: 0; line-height: 1.6; font-family:'Orbitron', sans-serif;">
            📝 Help us improve by sharing your thoughts and suggestions<br>
        </p>
    </div>
""", unsafe_allow_html=True)
...
if st.button("🚀 Submit Feedback"):
    if feedback_input.strip()  is not None:
        # Loading animation
        st.markdown("""
            <div class="loading-container">
                <div class="loading-spinner"></div>
                <div class="loading-text">🤖 Processing your feedback...</div>
                <p style="color: #b3b3b8; margin-top: 1rem;">
                    Analyzing feedback • Saving response • Thank you for your input
                </p>
            </div>
        """, unsafe_allow_html=True)
