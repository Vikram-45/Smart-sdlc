...
st.markdown("""
    ...
    <style>
        ...
        /* Input styling (for text input and text area) */
...
st.markdown("""
    <div class="feature-card">
        <p style="text-align: center; color: #b3b3b8; font-size: 1.2rem; margin: 0; line-height: 1.6; font-family:'Orbitron', sans-serif;">
            💬 Interact with our AI to get instant coding assistance and answers<br>
        </p>
    </div>
""", unsafe_allow_html=True)
...
# --- File Upload Section (Optional for Code or Context) ---
    ...
    if chat_input.strip() is not None:
        ...
        st.markdown("""
            <div class="loading-container">
                ...
                <div class="loading-text">🤖 AI is processing your message...</div>
                <p style="color: #b3b3b8; margin-top: 1rem;">
                    Analyzing input • Generating response • Optimizing answer
                </p>
            </div>
        """, unsafe_allow_html=True)
